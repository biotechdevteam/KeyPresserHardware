...
![KeyPresser Hardware](https://s2.loli.net/2026/01/20/Sz59lBnyZCaHtAu.png)
...
本项目采用 **Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)** 许可证，主要条款包括：

- **署名（Attribution）**：您必须给予适当的署名，提供许可证链接，并说明是否有修改。
- **非商业性使用（NonCommercial）**：您不得将本项目用于商业目的。
- **相同方式共享（ShareAlike）**：如果您修改、转换本项目或基于本项目进行创作，您必须基于相同的许可证分发您的贡献。

完整的许可证文本请参考项目根目录下的 [LICENSE](LICENSE) 文件。
