...
const Custom404 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground text-center p-6 space-y-8">
      <div>
      ...
      {/* Navigation Section */}
      <div>
        <h2 className="text-2xl font-semibold mb-4">Explore Other Pages:</h2>
