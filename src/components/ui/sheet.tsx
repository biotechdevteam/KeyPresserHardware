...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/95 p-6 shadow-lg transition ease-in-out backdrop-blur-md data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out overflow-y-auto",
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      ...
      sticky &&
        "sticky bottom-0 pb-4 pt-2 bg-card border-t border-muted-foreground",
      className
    )}
    {...props}
  />
